...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Yewsdhi/MUSIC_bot",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/bad_queeno")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/bad_queeno")
